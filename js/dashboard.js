        ...
        e('thead', {
            ...
            e('tr', null,
                ...
                e('th', {
                    ...
                    groupByCountry ? '國家' : '區域',
                    e(ColumnSorter, {
                        sortDirection: dataSort === covidSorts.country.key ? dataSortDirection : null
                    })
                ),
                e('th', {
                        sortable: 'sortable',
                    ...
                    e(ColumnSorter, {
                        sortDirection: dataSort === covidSorts.confirmed.key ? dataSortDirection : null
                    })
                ),
                e('th', {
                        sortable: 'sortable',
                    ...
                    e(ColumnSorter, {
                        sortDirection: dataSort === covidSorts.recovered.key ? dataSortDirection : null
                    })
                ),
                e('th', {
                        sortable: 'sortable',
                    ...
                    e(ColumnSorter, {
                        sortDirection: dataSort === covidSorts.deaths.key ? dataSortDirection : null
                    })
                ),
                e('th', {
                        sortable: 'sortable',
                        onClick: () => onColumnSort(covidSorts.mortality.key)
                    },
                    '發病',
                    e(ColumnSorter, {
                        sortDirection: dataSort === covidSorts.mortality.key ? dataSortDirection : null
                    })
                ),
            ),
        )
